...
That’s a Github heat map showing commits I’ve made over the last 12 months. During that time I have been steadily shipping code that actually works, with coding agents that get [more powerful](https://www.swebench.com/index.html) seemingly every day. Some of this code is just for me: [Codex](https://openai.com/codex/) chewing through a directory of PDFs with test results from my doctor to build a dashboard for me. Other projects are work related: a system for extracting co-investors and valuations from archived cap tables at [True](https://trueventures.com/).
